...
if( @ARGV == 0)
{
	print "Usage: funnel.pl <lisp executable> [<lisp options>]\n";
	print "	<lisp executable> The name to fork and execute.\n";
	print "		Usually one of: lisp, clisp, etc.\n";
	print "	<lisp options> Any options that you may wish to send\n";
	print "		to the afformentioned executable. (like -q)\n";
	exit(1);
}
...
$pipe_name = "/home/jgilmore/.lisp-pipe";
